...
# CORS configuration: Allow all origins (for development/public API)
CORS_ALLOW_ALL_ORIGINS = True
# If you need cookies/auth headers, uncomment below, but note the security caveats
# CORS_ALLOW_CREDENTIALS = True

# Optionally, you can specify allowed methods and headers, but defaults are usually sufficient
# CORS_ALLOW_METHODS = [
#     "DELETE",
#     "GET",
#     "OPTIONS",
